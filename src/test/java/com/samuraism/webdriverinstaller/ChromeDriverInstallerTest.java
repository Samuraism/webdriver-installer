...
class ChromeDriverInstallerTest {
    ...
    void getSuitableDriverVersion() {
        ...
        assertAll(
                () -> assertEquals("81.0.4044.69", installer.getSuitableDriverVersion(availableVersions, "82.0.4103.14").get())
                , () -> assertEquals("88.0.4324.96", installer.getSuitableDriverVersion(availableVersions, "88.0.4324.96").get())
                , () -> assertEquals("88.0.4324.96", installer.getSuitableDriverVersion(availableVersions, "88.0.4324.104").get())

                , () -> assertEquals("89.0.4389.23", installer.getSuitableDriverVersion(availableVersions, "89.0.5960.49").get())

                , () -> assertEquals("89.0.4389.23", installer.getSuitableDriverVersion(availableVersions, "95.0.1023.00").get())
        );
    }
}